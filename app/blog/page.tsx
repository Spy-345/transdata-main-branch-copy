      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.transdatanexus.com"}/blog`,
            breadcrumb: {
              "@type": "BreadcrumbList",
              itemListElement: [
                {
                  ...
                  position: 1,
                  name: "Home",
                  item: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.transdatanexus.com"}/`,
                },
                {
                  "@type": "ListItem",
                  position: 2,
                  name: "Blog",
                  item: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.transdatanexus.com"}/blog`,
                },
              ],
            },
            hasPart: (Array.isArray(blogs) ? blogs : [])
              .slice(0, 50)
              .map((b) => ({
                "@type": "BlogPosting",
                headline: b.title,
                datePublished: new Date(b.date).toISOString(),
                url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.transdatanexus.com"}/blog/${b.slug}`,
      ...
      <section className='relative bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 py-20 px-4'>
        ...
        <div className='relative max-w-6xl mx-auto text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-3xl mx-auto'>
            Stay ahead with expert analysis, market trends, and regulatory
            updates from the pharmaceutical trade industry
          </p>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          <div className='bg-white rounded-3xl p-12 shadow-2xl'>
            ...
            <p className='text-gray-600 mb-8 text-lg'>
              Get the latest pharmaceutical trade analysis, regulatory updates,
              and market trends delivered to your inbox.
            </p>
